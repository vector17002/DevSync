      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--white), var(--white-50)",
            }}
            key={item.name}
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-sm leading-[1.6] text-black font-base dark:text-white">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] text-black font-semibold dark:text-white">
                    {item.name}
                  </span>
                  <span className="text-sm leading-[1.6] text-black font-semibold dark:text-white">
                    {item.title}
